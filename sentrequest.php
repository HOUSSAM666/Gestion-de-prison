...
<!DOCTYPE html>
<html>
<?php $title="Gestion de prison | Envoyer Demande"; ?>
...
<body>
	...
	<table class="table table-responsive table-striped rounded mb-5">
		<tr><th colspan="8" class="title">Envoyer demande de transfert</th></tr>
		<tr>
			<th>#</th>
			<th>Nom de prison</th>
		...
		<tr>
			...
			<?php }
				...
				<a href="file/cancel.php?reqid=<?php echo $row['reqid'];?>" class="btn btn-danger">Annuler</a>
			<?php } ?>
			</td>
		</tr>
		<?php } ?>
